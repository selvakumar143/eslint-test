...
export default function SearchResults (props) {
    ...
    const { pageh1, introcopy } = useSearchResultsSEO(page_url_data['searchtypeVal'], page_url_data['areaVal'], page_url_data['buildingval'], page_url_data['bedVal'], page_url_data['minpriceVal'], page_url_data['maxpriceVal'], page_url_data['statusVal'], page_url_data['propertyTypeVal'])
