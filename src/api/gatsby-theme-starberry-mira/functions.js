  ...
  export default function formHandler(req, res) {
    ...
    axios.all([
      ...
      if (isProduction) {             
          ...
          // }
          to_admin = myformdata.to_email_id && myformdata.to_email_id !== "" ? myformdata.to_email_id+","+process.env.MAIL_TO :  process.env.MAIL_TO
          to_admin = myformdata.form_name === "Careers" ? process.env.CAREERS_MAIL_TO : to_admin
      }
      // SEND TO EMAILS ONLY ON PRODUCTION
