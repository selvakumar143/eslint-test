...
import { customStylesNews } from "./utils";
                ...
                <Col>
                    <div className="load-more-inner-wrap">
                        <div className="d-flex align-items-center justify-content-between">
                            <button className={`results-btn d-flex align-items-center`} onClick={() => handlePageChange("back")} disabled={currentPage <= 1}><i className="icon icon-results-back"></i> <span>Back</span></button>
