...
function GoogleResultMap (props) {
  ...
  return isLoaded ? (
      ...
      >
        ...
        <Marker key={(location.crm_id)} position={location?._geoloc} icon={currentInfo === location.crm_id ? active_marker_icon : marker_icon} onClick={(e) => onMarkerClick((location.crm_id), e)} >
        {
            ...
            >
              <div className="marker-tooltip">
                <PropertyCard data={location} key={i} />
              </div>
            </InfoWindow>    
          )
        }
