            ...
            <Row className="d-flex justify-content-center">
                <Col xl={10}>
                    <div className="text-center">
                        ...
                        <ul className="list-inline valuation-thanks-list">
                            <li className="list-inline-item">
                                <a href="javascript:;" className={selectState == "sales" ? "button-sec button-sec-primary-filled" : "button-sec button-sec-outline-dark"} onClick={() => setselectState("sales")}>Sales</a>
                            </li>
                            <li className="list-inline-item">
                                <a href="javascript:;" className={selectState != "sales" ? "button-sec button-sec-primary-filled" : "button-sec button-sec-outline-dark"} onClick={() => setselectState("lettings")}>Lettings</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="valuation-btn-wrapper">
                        <Link to="../" className="button-sec button-sec-primary-filled">Book a valuation appointment</Link>
                    </div>
