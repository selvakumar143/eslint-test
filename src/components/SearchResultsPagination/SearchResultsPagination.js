        ...
        <div className={`load-more-wrap ${props.tag}`}>
            {props?.total &&
                ...
                <div className="d-flex align-items-center justify-content-between">
                    <button className={`results-btn d-flex align-items-center ${props?.current_page_number > 0 ? "" : "disabled"}`} disabled={props?.current_page_number > 0 ? "" : "disabled"} onClick={() => prevpage()}><i className="icon icon-results-back"></i> <span className="secondary-text d-md-block d-none">Back</span></button>
                    ...
                    <button className={`results-btn d-flex align-items-center ${(props?.current_page_number + 1) === props?.nbPages ? "disabled" : ""}`} disabled={(props?.current_page_number + 1) === props?.nbPages ? "disabled" : ""} onClick={() => nextpage()}><span className="secondary-text d-md-block d-none">Next</span> <i className="icon icon-results-next"></i></button>
                </div>
            }
        </div>
    );
