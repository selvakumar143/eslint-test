...
const InputField = ({ startDate, setStartDate, startTime, setStartTime, fieldClass, labelClass, type, name, value, required, placeholder, handlechange, pattern, label, grpmd, step, inputlabel, className, submit_tag }) => {
        ...
        {type === 'timePicker' ?
          <>
            ...
            : type === 'date_time' ?
              ...
              {submit_tag === "arrow" &&
              <button className="news-btn" type="submit"><i className="icon icon-news-arrow"></i></button>              
              }
