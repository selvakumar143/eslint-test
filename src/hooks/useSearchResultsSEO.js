const useSearchResultsSEO = (action, area, property_type, bedroom, minprice, maxprice, propertyTypeVal) => {
    ...
    introcopy = `Explore our ${pageh1.replace("Property", "property")}. For more information about property ${myactin} ${myarea ? 'in '+myarea:''}, please <a href='/contact/'>get in touch</a> with ${process.env.GATSBY_SITE_NAME}.`
